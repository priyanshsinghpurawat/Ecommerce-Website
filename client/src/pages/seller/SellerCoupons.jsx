// client/src/pages/seller/SellerCoupons.jsx
  ...
  const fetchCouponsList = async () => {
    ...
    try {
      ...
      if (response && response.success) {
        // Note: API returns all coupons for filtering on seller side
        // In a real scenario, the backend would have seller-specific endpoints
        // For now, we're mimicking admin behavior but seller should see only their coupons
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold uppercase tracking-wider text-app-text">My Coupons</h2>
          <p className="text-xs text-app-text/50">Manage your storefront promotional discount codes.</p>
        </div>

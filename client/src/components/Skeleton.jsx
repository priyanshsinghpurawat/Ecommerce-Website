...
export const ProductCardSkeleton = () => {
  return (
    <div className="flex flex-col gap-3 animate-pulse">
      <div className="aspect-[4/5] w-full rounded-sm bg-lux-100" />
      <div className="space-y-2">
        <div className="h-3 w-3/4 rounded bg-lux-100" />
        <div className="h-4 w-1/2 rounded bg-lux-100" />
      </div>
    </div>
  );
};
...
export const DashboardTableSkeleton = () => {
  return (
    <div className="overflow-hidden rounded-2xl border border-white/60 bg-lux-50/40 shadow-soft backdrop-blur-md animate-pulse">

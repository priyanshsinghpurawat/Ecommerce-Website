  ...
  return (
    <div className="group flex flex-col bg-app-bg overflow-hidden animate-in fade-in duration-500">
      ...
      >
        ...
        <div className={`absolute inset-x-0 bottom-0 z-30 bg-black/80 backdrop-blur-md p-4 transition-all duration-300 transform ${
        ...
        <div className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-4 pt-12 transition-all duration-300 ${
          isHovered && !showSizes ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}>
          <button
            type="button"
            onClick={(e) => {
      ...
      <div className="pt-4 space-y-1.5">
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-[9px] font-black uppercase tracking-widest text-brand-primary bg-app-text px-2 py-0.5 rounded-md">
            {product.seller?.brandName || 'Originals'}
          </span>
          <span className="h-px flex-1 bg-surface-100/50" />
